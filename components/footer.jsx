      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="https://stutorpal.com/" className="flex items-center">
              <img src="https://stutorpal.github.io/waitlist/img/logo.png" className="h-8 mr-3" alt="FlowBite Logo" />
              <span className="self-center text-2xl font-semibold whitespace-nowrap ">Stutorpal</span>
            </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="font-medium">
                <li className="mb-4">
                  <a href="https://www.linkedin.com/in/stutorpal-community-1a364b287/" className="hover:text-blue-600 ">LinkedIn</a>
                </li>
                <li>
                  <a href="https://www.twitter.com/stutorpal" className="hover:text-blue-600">Twitter</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm  sm:text-center ">© 2023 <a href="/" className="hover:text-blue-600">Stutorpal™</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">

            <a href="#" className=" hover:text-blue-900 dark:hover:text-blue-900">
