...
<div className="flex justify-center w-full  items-center">
  <div className="bg-white shadow-md m-5 rounded px-8 pt-6 pb-8 mb-4 w-full max-w-md">
  ...
  title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Enter your password" required/>
      ...
      <div className="flex items-center justify-center">
        <button onClick={login} type="submit" className="bg-blue-500 text-white px-16 py-4 rounded-lg font-bold tracking-widest w-full hover:bg-blue-800">
          LogIn
        </button>
      </div>
