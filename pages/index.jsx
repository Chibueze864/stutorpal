            ...
            <div className="flex items-center w-full lg:w-1/2">
              <div className="max-w-2xl  lg:text-left md:text-left sm:text-center px-4  mb-8">
                ...
                <p className="py-3 text-xl leading-normal lg:text-xl xl:text-2xl">
                  When trying to get the best of grades, with us you will ace the tests you take. The first peer-to-peer tutorship app. For students by students     </p>
                ...
                <div className="py-3 flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
                  <div className="flex mt-1 w-48 h-14 bg-blue text-white rounded-lg items-center justify-center" style={{ backgroundColor: "#3673E6" }}>
                    <div className="mr-3">
                  ...
                  <div className="flex mt-5 w-48 h-14 bg-black text-white rounded-xl items-center justify-center" style={{ backgroundColor: "#3673E6" }}>
                    <div className="mr-3">
          ...
          <div >
            ...
            <Container className="flex flex-wrap pt-5">
              ...
              <div className="p-3  w-full grid grid-cols-1 grid-cols-1 lg:grid-cols-2">
                                      <div >
                          <Image src={customerSupportImage} style={{height:"inherit"}} alt="customer support image" />
                      </div>
                ...
                <div className="space-y-8">
                  <div>
                    <label  className="block mb-2 text-sm font-medium text-black-900 dark:text-black-300">Your email</label>
                    <input type="email" id="email" className="shadow-sm  border border-gray-300 text-black-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5  dark:border-gray-600 dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="name@flowbite.com" required />
                  </div>
                  <div>
                    <label  className="block mb-2 text-sm font-medium text-black-900 dark:text-black-300">Subject</label>
                    <input type="text" id="subject" className="shadow-sm  border border-gray-300 text-black-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5  dark:border-gray-600 dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Let us know how we can help you" required />
                  </div>
                  <div className="sm:col-span-2 ">
                    <label className="block mb-2 text-sm font-medium text-black-900 dark:text-black-400">Your message</label>
                    <textarea id="message" rows="6" className="shadow-sm  border border-gray-300 text-black-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5  dark:border-gray-600 dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Leave a comment..."></textarea>
                  <a href={`mailto:stutorpal@gmail.com?subject=${subject}&body=${message}`}> <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300shadow-sm  border border-gray-300 text-black-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5  dark:border-gray-600 dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light mt-4 py-5">Submit</button></a> 
                  </div>
