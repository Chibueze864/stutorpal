...
<div>
  ...
  <div className="mb-5 max-w-2xl mx-auto">
    <h1 href="#" className="text-gray-900 pb-4 font-bold text-3xl mb-2">{blogPost.header}</h1>

    <div className="pb-4 text-gray-700 text-xs flex my-6 flex justify-between">
      <div className="flex items-center">
      <a href="#"><img className="w-12 h-12 rounded-full mr-2" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROXyfGAFLE7uuIrF6Qmi7QKmL6tBgx9Hs7SzWUg50AFw&s" alt="Avatar of Jonathan Reinink pb-2"/></a>
      <div className="text-sm">
        <a href="#" className="text-gray-900 font-medium leading-none hover:text-indigo-600 transition duration-500 ease-in-out pb-2">{blogPost.author}</a>
        <p className="text-gray-600 text-xs pb-2">{blogPost.date}</p>
      </div>
    </div>
     </div>
  </div>
  ...
  <div className="max-w-2xl mx-auto">
   ...
   { blogPost.img &&    <div className="bg-cover  h-64 text-center overflow-hidden" style={dynamicStyles} title="Woman holding a mug">
            </div>}
        <div className="">
           <p className="text-base leading-8 my-10 break-words ">          {blogPost.content}
</p>
              {/* <p className="text-base leading-8 my-10">
          ...
          <blockquote className="text-md italic leading-8 my-5 p-8 text-indigo-600 font-semibold">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</blockquote>*/}
